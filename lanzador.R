...
source("mutacion.R")                 #define la funcion mutacion()
source("evolutivo.R")                #define la funcion evolutivo()
...
prob <- c("Ackley", "Bukin6", "CrossInTray","DropWave","Eggholder",
          "GramacyLee12","Griewank","HolderTable", "Langermann","Levy",
          "Levy13", "Rastrigin","Schaffer2","Schaffer4","Schwefel",
          "Shubert","Bohachevsky1","Bohachevsky2","Bohachevsky3","Perm0db",
          "Rothyp","Sphere","Sphere2","Sumpow","Sumsqu",
          "Trid","Booth","Matyas","Mccormick","Powersum",
          "Zakharov","Camel3","Camel6","DixonPrice","Rosenbrock1",
          "Rosenbrock2","DeJong5","Easom","Michalewicz","Beale",
          "Branin1","Branin2","Branin3","Colville","Forrester",
          "GoldsteinPrice","Hartmann3D","Hartmann4D","Hartmann6D","Permdb",
...
sizePopulation <- 200   #tamano de la poblacion
numIteraciones <- 5000  #numero de iteraciones del algoritmo (número de generaciones)
...
#de optimizacion numRepeticiones veces, obteniendo una
#coleccion de valores de tiempo de ejecucion y valor alcanzado
